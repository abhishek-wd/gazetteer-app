...
$url = 'https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browsequotes/v1.0/GB/GBP/en-GB/LHR-iata/'
.$_REQUEST['destinationIata'].'-iata/'.$_REQUEST['departureDate'].'?inboundpartialdate='.$_REQUEST['arrivalDate'];
